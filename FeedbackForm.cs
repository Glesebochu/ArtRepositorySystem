    ...
    internal class FeedBackForm : UserControl
    {
        ...
        private List<DrakeUITitlePanel> generatePanels(int numberOfPanels)
        {
            ...
            for (int i = 0; i < numberOfPanels; i++)
            {
                ...
                panel.Location = new Point((this.Width), 20 + i * 220);
                panel.Width = 740;
                panel.Height = 200;
                panel.Radius = 30;
        ...
        private void populatePanels() {
            for (int index = 0; index < this.listOfGeneratedPanels.Count; index++)
            {
                ...
                if (index == 0)
                {
                    ...
                    choice1[0].Text = "Yes";
                    choice1[0].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    ...
                    choice1[1].Text = "No";
                    choice1[1].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    ...
                    choice1[2].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    ...
                    choice1[3].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                ...
                {
                    // Button1
                    choice2[0].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    choice2[0].Text = "Yes";
                    choice2[0].Location = new Point(30, 60);
                    choice2[0].BackColor = Color.LightGray;

                    // Button2
                    choice2[1].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    choice2[1].Text = "No";
                ...
                {
                    // Button1
                    choice3[0].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    choice3[0].Text = "Yes";
                    choice3[0].Location = new Point(30, 60);
                    choice3[0].BackColor = Color.LightGray;

                    // Button2
                    choice3[1].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    choice3[1].Text = "No";
                ...
                {
                    // Button1
                    choice4[0].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    choice4[0].Text = "Yes";
                    choice4[0].Location = new Point(30, 60);
                    choice4[0].BackColor = Color.LightGray;

                    // Button2
                    choice4[1].Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    choice4[1].Text = "No";
                ...
                else if(index == 4)
                {
                    ...
                    answerBox.Font = new Font("Segoe UI", 12, FontStyle.Regular);
                    answerBox.Radius = 20;
